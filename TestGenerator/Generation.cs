...
namespace TestGenerator
{
    public class Generation
    {
        ...
        public Dictionary<string, string> GenerateTests(Files fileData)
        {
        ...
        private ClassDeclarationSyntax GenerateClass(Classes classData)
        {
        ...
        private Constructors FindLargestConstructor(List<Constructors> constructors)
        {
        ...
        private void GenerateActPart(List<StatementSyntax> body, Methods methodInfo, string checkedClassVariable)
        {
        ...
        private MethodDeclarationSyntax GenerateMethod(Methods methodInfo, string checkedClassVar)
        {
            List<StatementSyntax> body = new List<StatementSyntax>();
